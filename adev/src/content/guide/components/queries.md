...
그래서 시그널 함수를 실행하면 자식 객체를 참조할 수 있으며, `computed` 나 `effect` 함수와 함께 사용해서 [반응형 시그널](guide/signals#reactive-contexts)로 활용할 수도 있습니다.
...
-->
### 컨텐츠 쿼리 {#decorator-content-queries}
