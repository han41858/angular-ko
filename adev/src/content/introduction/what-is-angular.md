...
<docs-nav-card title="코드를 보고 싶나요?" iconImgSrc="adev/src/assets/icons/star.svg">
  <docs-nav-link title="핵심" iconName="docs" href="essentials" iconImgSrc="adev/src/assets/icons/docs.svg">
    Angular 사용방법을 안내합니다.
  </docs-nav-link>
...
<docs-card-container headerTitle="개발 지원 기능" headerImgSrc="adev/src/assets/images/learn-angular-browser-bw.svg">
  <docs-card title="컴포넌트" href="essentials/components" link="컴포넌트를 알아봅시다" iconImgSrc="adev/src/assets/icons/components.svg">
    Angular 컴포넌트를 활용하면 코드를 기능 단위로 쉽게 분리할 수 있습니다.
  </docs-card>
  <docs-card title="Angular 시그널" href="essentials/signals" link="Angular 시그널을 알아봅시다. titleIconName="sensors" iconImgSrc="adev/src/assets/icons/signals.svg">
    정교하게 설계된 반응형 모델은 컴파일 타임 최적화와 함께 개발 단계를 단순화하고 앱을 빠르게 개발하는 데 도움을 줍니다.
  </docs-card>
  <docs-card title="서버-사이드 렌더링" href="guide/ssr" link="SSR을 확인해 보세요" iconImgSrc="adev/src/assets/icons/ssr.svg">
    Angular는 서버 사이드 렌더링(SSR)과 정적 사이트 생성(SSG)을 모두 지원하며, 완전한 DOM 하이드레이션도 지원합니다.
  </docs-card>
  <docs-card title="의존성 주입" href="essentials/dependency-injection" link="의존성 주입은 무엇일까요" iconImgSrc="adev/src/assets/icons/di.svg">
    애플리케이션 전 영역에 걸쳐 코드를 쉽게 재사용할 수 있습니다.
  </docs-card>
  <docs-card title="Angular 라우팅" href="guide/routing" link="Angular 라우팅을 알아봅시다" iconImgSrc="adev/src/assets/icons/routing.svg">
    라우팅 가드, 데이터 전달, 지연 로딩 등 다양한 네비게이션 기능을 제공합니다.
  </docs-card>
  <docs-card title="폼" href="guide/forms" link="폼 구성 방법을 알아봅시다" iconImgSrc="adev/src/assets/icons/forms.svg">
...
<docs-card-container headerTitle="어떤 규모에도 적합합니다" headerImgSrc="adev/src/assets/images/servers.svg">
  ...
  <docs-card title="사용자를 보호하는 보안은 기본입니다" href="best-practices/security" link="보안" titleIconName="sensors">
  ...
  <docs-card title="Vite와 esbuild로 대규모 팀 생산성을 유지하세요" href="tools/cli/build-system-migration" link="ESBuild, Vite" titleIconName="sensors">
...
<docs-card-container headerTitle="오픈 소스 퍼스트" headerImgSrc="adev/src/assets/images/open-source.svg">
  <docs-card title="GitHub에 공개되어 있습니다" href="https://github.com/angular/angular" link="GitHub을 방문해 보세요" titleIconName="sensors">
  ...
  <docs-card title="로드맵도 투명하게 공개합니다" href="roadmap" link="로드맵을 확인해 보세요" titleIconName="sensors">
...
<docs-card-container headerTitle="방대한 커뮤니티" headerImgSrc="adev/src/assets/images/community.svg">
  ...
  <docs-card title="오픈 소스" href="https://github.com/angular/angular/blob/main/CONTRIBUTING.md" link="Angular에 기여하세요" titleIconName="sensors">
    Angular를 더 나은 프레임워크로 만드는 데 기여하는 오픈 소스 컨트리뷰터 모두에게 감사드립니다.
    문서의 오타 수정부터 주요한 기능 추가까지, 관심있는 분들은 GitHub에서 함께 해보세요.
  </docs-card>
  <docs-card title="커뮤니티 파트너십" href="https://developers.google.com/community/experts/directory?specialization=angular" link="Angular GDE들을 만나보세요" titleIconName="sensors">
