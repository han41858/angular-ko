<docs-decorative-header title="다음 단계" imgSrc="adev/src/assets/images/roadmap.svg"> <!-- markdownlint-disable-line -->
...
온라인 코드 에디터에서 직접 Angular 코드를 작성해 보세요.

<docs-pill-row>
  <docs-pill title="Angular와 놀아봅시다!" href="playground" />
</docs-pill-row>
...
브라우저에서 실행되는 튜토리얼을 통해 Angular의 주요 개념을 실제로 적용해 보거나, Angular CLI로 로컬 환경에서 첫 번째 앱을 만들어 보세요.

<docs-pill-row>
  <docs-pill title="Angular 기본 개념 알아보기" href="tutorials/learn-angular" />
  <docs-pill title="첫 번째 Angular 앱 만들어보기" href="tutorials/first-app" />
</docs-pill-row>
...
다른 심화 가이드 문서를 확인하려면 왼쪽 네비게이션 메뉴를 참고하세요.
