...
직접 작성해 볼 수 있는 튜토리얼을 활용해서 Angular 앱 개발을 시작해 보세요.
...
Angular를 이해하려면 HTML, CSS, JavaScript 기본 지식이 필요합니다.

각 단계마다 Angular의 개념을 하나씩 살펴봅시다.
하나만 도전해 볼 수 있고, 전체를 한 번에 끝낼 수도 있습니다.
